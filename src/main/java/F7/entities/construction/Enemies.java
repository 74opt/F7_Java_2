...
public class Enemies { 
    private static Enemy bear = new Bear("Bear", "Native to these lands,\nand very territorial.", 14, 4, 1, 68, Rarities.COMMON);

    private static Enemy hobo = new Hobo("Hobo", "Putting up a fight\nwith an F7 android? \nThis can't go well for them.", 6, 5, 1, 73, Rarities.COMMON);
    
    private static Enemy nomad = new Nomad("Nomad", "Weary travelers who want\nyour parts for cash.", 18, 4, 1, 75, Rarities.UNCOMMON);

    private static Enemy swarm = new Swarm("Swarm of Bees", "Not something you want\nto be caught up in.", 22, 3, 1, 68, Rarities.UNCOMMON);

    private static Enemy f3 = new F3("F3", "A younger generation of\nthe F-series android. They\nexist only to fight.", 12, 6, 1, 84, Rarities.RARE);
    
    private static Enemy logger = new Logger("Logger", "Big.\nBulky.\nHas a chainsaw.\nDon't get hit.", 18, 11, 1, 35, Rarities.RARE);

    private static Enemy mutantHawk = new Hawk("Mutant Hawk", "The hawks around here\nhave been hanging around\nthe radiation for too long.", 24, 6, 1, 70, Rarities.EXCEPTIONAL);

    private static Enemy tank = new Tank("M7-Abrams Tank", "This hunk of metal\ncould destroy you in\nan instant.", 40, 10, 1, 30, Rarities.EXCEPTIONAL);

    private static Enemy angel = new Angel("Angel", "They've had enough\nof your hubris.\nYou go against the\nnatural law. ", 16, 10, 1, 95, Rarities.GODLY);
